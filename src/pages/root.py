...
def create() -> None:
    ...
    def root():
        ...
        with ui.row().classes('w-full'):
            ui.label("Welcome").classes('text-xl font-semibold')
        with ui.row().classes('w-full h-full'):
            ...
            #         if patient.amputation_type not in amputationTypeList:
            #             amputationTypeList.append(patient.amputation_type)
            ...
            # main section
            for patient in patients:
                with ui.card().classes('w-full h-full bg-[#E5E5E5]'):
                    with ui.row().classes('items-center justify-between w-full'):
                        with ui.row().classes('items-center gap-2'):
                            ui.icon('account_circle').classes('text-5xl text-black')
                            full_name = f"{patient.first_name} {patient.last_name}"
